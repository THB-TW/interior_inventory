...
class LineWebhookServiceTest {
  ...
  @BeforeEach
  void setUp() {
    // Since we injected the real ObjectMapper in the real code, we should set a
    // real one here.
  ...
  void testProcessWebhookPayload_Success() throws Exception {
    ...
    when(restTemplate.exchange(
        ...
        eq(String.class))).thenReturn(new ResponseEntity<>(mockProfileResponse, HttpStatus.OK));
