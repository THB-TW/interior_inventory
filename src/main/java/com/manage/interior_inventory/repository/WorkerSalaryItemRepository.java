...
public interface WorkerSalaryItemRepository extends JpaRepository<WorkerSalaryItem, Long> {
        ...
        // refresh upsert 查詢：同期別 + 同師傅 + 同案件 + 同薪資類型
        Optional<WorkerSalaryItem> findByPeriodIdAndWorkerIdAndProjectIdAndWageType(
                        Long periodId, Long workerId, Long projectId, String wageType);
